...
static void test_bulletproof_api(void) {
    ...
    /* generators */
    gens = secp256k1_bulletproof_generators_create(none, NULL, 256, 1);
    CHECK(gens == NULL && ecount == 1);
    gens = secp256k1_bulletproof_generators_create(none, &secp256k1_generator_const_h, 256, 0);
    CHECK(gens == NULL && ecount == 2);
    gens = secp256k1_bulletproof_generators_create(none, &secp256k1_generator_const_h, 256, 3);
    CHECK(gens == NULL && ecount == 3);
    gens = secp256k1_bulletproof_generators_create(none, &secp256k1_generator_const_h, 256, 33);
    CHECK(gens == NULL && ecount == 4);
    gens = secp256k1_bulletproof_generators_create(none, &secp256k1_generator_const_h, 256, 64);
    CHECK(gens == NULL && ecount == 5);
    gens = secp256k1_bulletproof_generators_create(none, &secp256k1_generator_const_h, 256, 1);
    CHECK(gens != NULL);
...
void run_bulletproofs_tests(void) {
    ...
    secp256k1_bulletproof_generators *gens = secp256k1_bulletproof_generators_create(ctx, &secp256k1_generator_const_h, 32768, 1);
