...
int main(void) {
    ...
    /* TODO: I think we're recreating the pedersen commitment here */
    /* TODO: shouldn't this be 117? */
    if (!secp256k1_pedersen_commit(ctx, &commitment, blinds[0], 100, &secp256k1_generator_const_h, &secp256k1_generator_const_h)) {
        printf("ERR commit\n");
        return 0;
    }
